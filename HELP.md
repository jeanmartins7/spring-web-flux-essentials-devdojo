...
* The original package name 'spring.web.flux.essentials-dev-dojo' is invalid and this project uses 'spring.web.flux.essentials_devdojo' instead.
...
```
$ docker run --rm essentials-devdojo:0.0.1-SNAPSHOT
```
